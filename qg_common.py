...
(800, 1000), (1000, 1500), (1500, 2000), (2000, 6500) 
]
...
VAR_UNFOLD_DICT_TARGET0p5 = {
    ...
    'jet_width': {
        ...
        'gen': np.array([0.0, 0.09, 0.145, 0.205, 0.28, 0.355, 0.435, 0.525, 1.0], dtype='d'),
        'reco': None
    },
    'jet_thrust': {
    ...
    'jet_pTD_charged': {
        ...
        'gen': np.array([0.0, 0.07, 0.09, 0.11, 0.14, 0.18, 0.23, 0.3, 0.39, 0.51, 0.65, 1.0], dtype='d'),
        'reco': None
    },
    'jet_LHA_charged': {
        ...
        'gen': np.array([0.0, 0.06, 0.1, 0.15, 0.21, 0.27, 0.34, 0.42, 0.5, 0.58, 0.67, 1.0], dtype='d'),
        'reco': None
    },
    'jet_width_charged': {
        # 'gen': np.array([0.0, 0.015, 0.025, 0.035, 0.05, 0.065, 0.085, 0.105, 0.13, 0.16, 0.195, 0.235, 0.28, 0.335, 0.4, 0.48, 0.585, 1.0], dtype='d'),
        'gen': np.array([0.0, 0.01, 0.025, 0.045, 0.075, 0.11, 0.155, 0.215, 0.28, 0.35, 0.425, 0.51, 0.615, 1.0], dtype='d'),
        'reco': None
    },
    'jet_thrust_charged': {
        # 'gen': np.array([0.0, 0.005, 0.01, 0.015, 0.025, 0.035, 0.05, 0.065, 0.085, 0.115, 0.15, 0.2, 0.265, 0.355, 0.48, 0.725, 1.], dtype='d'),
        'gen': np.array([0.0, 0.005, 0.015, 0.03, 0.06, 0.11, 0.17, 0.24, 0.325, 0.44, 1.0], dtype='d'),
        'reco': None
    },
}
